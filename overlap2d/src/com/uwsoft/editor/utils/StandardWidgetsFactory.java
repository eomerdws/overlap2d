...
public class StandardWidgetsFactory {
    ...
    public static Spinner CreateSpinner(IntSpinnerModel spinnerModel) {
        return CreateSpinner("default", spinnerModel);
    }

    public static Spinner CreateSpinner(String style, IntSpinnerModel spinnerModel) {
        Spinner selector = new Spinner(style, "", spinnerModel);
        return selector;
    }
}
